    ...
    <DocTemplateVue>
        <template v-slot:index="{ s }">
            ...
            <DocA
                ...
                :cps="1"
            ></DocA>
            <DocA href="#Method" content="Method" bgc="#1C4D7C" h="82" :s="s" :cps="2"></DocA>
            <DocA href="#Introduction" content="Introduction" bgc="#3076B5" h="75" :s="s" :cps="3"></DocA>
            <DocA href="#Results" content="Results" bgc="#03A1FF" h="68" :s="s" :cps="4"></DocA>
            <DocA2 href="#Object1-I" content="Object1 I" bgc="#56C1FF" h="61" :s="s" :cps="5"></DocA2>
            <DocA2 href="#Object1-II" content="Object1 II" bgc="#56C1FF" h="54" :s="s" :cps="6"></DocA2>
            <DocA2 href="#Object2-I" content="Object2 I" bgc="#56C1FF" h="47" :s="s" :cps="7"></DocA2>
            <DocA2 href="#Object2-II" content="Object2 II" bgc="#56C1FF" h="40" :s="s" :cps="8"></DocA2>
            <DocA2 href="#Object3" content="Object3" bgc="#56C1FF" h="33" :s="s" :cps="9"></DocA2>
            <DocA3 href="#" bgc="#FFD368" w="20" h="26">
                <span class="-rotate-90 block absolute top-8 left-[55%] -translate-x-1/2">TOP</span>
            </DocA3>
        </template>
        <template v-slot:content>
            <DocH2 title="Data collection" id="Data-collection"></DocH2>
            <p>For the reason of pandemic-controlling period, we used the data published online instead of collecting samples from children and their mothers.</p>
            <DocH2 title="Data analysis" id="Data-analysis"></DocH2>
            ...
            <DocH2 title="Method" id="Method"></DocH2>
            <h4>Pathway enrichment analysis</h4>
            <p>
                <span>Pathway enrichment analysis of the interaction between differentially expressed genes was analyzed by the DAVID database (</span>
                <DocLink href="https://david.ncifcrf.gov/">https://david.ncifcrf.gov/</DocLink>
                <span>). We calculated the P-value, False Discovery Rate (FDR), and enrichment value and selected the immune-related pathways with P-value &lt; 0.05 for further analysis.</span>
            </p>
            <h4>Gene set enrichment analysis (GSEA)</h4>
            <p>
                <span>The 159 cases were generated from the GEO dataset. The 159 cases were categorized into an ASD group and a TD group. We performed GSEA analysis using GSEA v4.1.0 software(</span>
                <DocLink
                    href="http://software.broadinstitute.org/gsea/index.jsp"
                >http://software.broadinstitute.org/gsea/index.jsp</DocLink>). Briefly, the enrichment score (ES) was calculated as the maximum deviation from zero of the weighted fractions of genes present minus the fraction not present up to a given index in a gene expression matrix ordered by phenotype correlation. Statistical significance was assessed by comparing the enrichment score with the enrichment results generated from 1000 random permutations of the gene set to obtain P-values.
            </p>
            ...
            <DocH3 title="Object1 I" id="Object1-I"></DocH3>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/1/12/T--NJMU-China--Model1.1.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/f/fa/T--NJMU-China--Model1.2.png"></DocImg>
            <p>
                <span>We search genes which enriched in the “IMMUNE” pathway on the PubMed(</span>
                <DocLink href="https://pubmed.ncbi.nlm.nih.gov/">https://pubmed.ncbi.nlm.nih.gov/</DocLink>) to annotate specific functions. The result showed the upregulated and downregulated genes are mainly associated to CD4+ T cells, Th17 cells and Treg cells(Figure 1C).
            </p>
            <DocImg src="https://2021.igem.org/wiki/images/a/ac/T--NJMU-China--Model1.3.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/9/9f/T--NJMU-China--Model1.4.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/6/6b/T--NJMU-China--Model1.5.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/7/7d/T--NJMU-China--Model1.6.png"></DocImg>
            <br />
            <br />
            <DocH3 title="Object1 II" id="Object1-II"></DocH3>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/5/5d/T--NJMU-China--Model2.1.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/b/b0/T--NJMU-China--Model2.2.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/e/e7/T--NJMU-China--Model2.3.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/d/da/T--NJMU-China--Model2.4.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/8/84/T--NJMU-China--Model2.5.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/e/e5/T--NJMU-China--Model2.6.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/c/c0/T--NJMU-China--Model2.7.png"></DocImg>
            <p>The AUC area is 0.820, achieving an obvious improvement compared to Random Forest.</p>
            <DocImg src="https://2021.igem.org/wiki/images/0/04/T--NJMU-China--Model2.8.png"></DocImg>
            <!--  -->
            <DocH3 title="Object2 I" id="Object2-I"></DocH3>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/e/e1/T--NJMU-China--Model3.3.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/5/56/T--NJMU-China--Model3.4.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/5/5d/T--NJMU-China--Model3.5.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/7/70/T--NJMU-China--Model3.6.png"></DocImg>
            <p>Notes: SRS-P = caregiver-rated Social Responsiveness Scale. ADOS = Autism Diagnostic Observation Schedule. DBC-P = caregiver-rated Developmental Behavior Checklist. RBS-R-P = caregiver-rated Repetitive Behavior Scale – Revised. CSQ = Caregiver Strain Questionnaire. The higher the scores of all the above scales, the greater the damage</p>
            <DocH3 title="Object2 II" id="Object2-II"></DocH3>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/9/9d/T--NJMU-China--Model4.1.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/b/b8/T--NJMU-China--Model4.4.png"></DocImg>
            <DocImgDetail>(the initial model)</DocImgDetail>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/4/46/T--NJMU-China--Model4.5.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/9/96/T--NJMU-China--Model4.6.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/9/98/T--NJMU-China--Model4.7.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/0/05/T--NJMU-China--Model4.8.png"></DocImg>
            ...
            <DocH3 title="Object3" id="Object3"></DocH3>
            <p>Verify the rationality of the project design through mathematical modeling and 3-D modeling</p>
            <h4>1. MicroRNA 3-D model</h4>
            <p>
                <span>As a preliminary characterization and verification of our parts, we simulated the interactions between microRNA 126a and DNMT3B.We first simulated the 3p and 5p of the microRNA structure in 3dRNAwebsite[9](</span>
                <DocLink
                    href="http://biophy.hust.edu.cn/new/3dRNA"
                >http://biophy.hust.edu.cn/new/3dRNA</DocLink>) (Figure 5A).
            </p>
            <DocImg src="https://2021.igem.org/wiki/images/5/51/T--NJMU-China--Model5.1.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/3/33/T--NJMU-China--Model5.2.png"></DocImg>
            <p>
                <span>Analysis by BiBiServ website[10](</span>
                <DocLink href="https://bibiserv.com/">https://bibiserv.com/</DocLink>)showed that the seed sequence of miRNA-126a 3p end had four potential binding sites (2 in 3’ UTR, 1 in CDS and 1 in 5’ UTR) with DNMT3B mRNA. The seed sequence of miRNA-126a 5p end had three potential binding sites (3 in CDS) with DNMT3B mRNA(Figure 5B).
            </p>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/c/ce/T--NJMU-China--Model5.3.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/1/1c/T--NJMU-China--Model5.4.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/0/0d/T--NJMU-China--Model5.5.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/6/69/T--NJMU-China--Model5.6.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/e/ec/T--NJMU-China--Model5.7.png"></DocImg>
            <DocImg
                src="https://2021.igem.org/wiki/images/0/0b/T--NJMU-China--Model5.8--compressed.png"
            ></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/b/b0/T--NJMU-China--Model5.9.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/2/20/T--NJMU-China--Model5.10.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/d/dc/T--NJMU-China--Model5.11.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/e/e3/T--NJMU-China--Model5.12.png"></DocImg>
            <p>
                Then we obtained the structure of Tryptophan from PubChem.(Figure 5D)
                <br />
                <span>(</span>
                <DocLink href="https://pubchem.ncbi.nlm.nih.gov">https://pubchem.ncbi.nlm.nih.gov</DocLink>)
            </p>
            <DocImg src="https://2021.igem.org/wiki/images/b/b3/T--NJMU-China--Model5.13.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/7/77/T--NJMU-China--Model5.14.png"></DocImg>
            ...
            <DocImg
                src="https://2021.igem.org/wiki/images/9/9a/T--NJMU-China--Model5.15--compressed.png"
            ></DocImg>
            <DocImgDetail>Figure 3.3D Structure of RNA~Tryptophan</DocImgDetail>
            <DocImgDetail>(Red-A,Blue-T,Green-G,Yellow-C;Presented by the Chimera X[14, 15])</DocImgDetail>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/5/58/T--NJMU-China--Model5.16.png"></DocImg>
            ...
            <p>To characterize and verify our parts preliminarily, we simulated the interactions between oxytocin and the receptor. We found the amino acid sequence of mouse oxytocin receptor, and employed the human oxytocin receptor as a template, using homology modeling to predict protein structures from SWISS-MODEL. Since the structure of oxytocin could not be found in the database, we constructed the structure of oxytocin using PEP-fold3[16, 17], and then used Autodock Vina for molecular docking.(Figure 5G)</p>
            <DocImg src="https://2021.igem.org/wiki/images/0/0d/T--NJMU-China--Model5.17.png"></DocImg>
            <DocImg src="https://2021.igem.org/wiki/images/2/20/T--NJMU-China--Model5.18.png"></DocImg>
            <p>The top five models (by the binding energy) of our 20 predicted models are as follows.</p>
            <DocImg src="https://2021.igem.org/wiki/images/0/03/T--NJMU-China--Model5.19.png"></DocImg>
            <h4>4. Bacteria growth model</h4>
            <p>As the therapeutic effects of engineered bacteria, it is of great importance to predict growth rate--we need to know whether the growth of our bacteria meets up our expectations in vivo and vitro.</p>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/9/99/T--NJMU-China--Model5.20.png"></DocImg>
            <p>The Logistic equation is the most commonly used model for describing bacterial growth dynamics[18], especially in systems biology and computational biology. This equation is commonly used to fit growth curves based on optical density (OD) to understand the dynamics of living systems.</p>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/a/aa/T--NJMU-China--Model5.21.png"></DocImg>
            <p>where N is the population size, t - resource, K - maximum result, r - birthrate. And the equation can be solved as followed.</p>
            <DocImg src="https://2021.igem.org/wiki/images/f/f4/T--NJMU-China--Model5.22.png"></DocImg>
            <p>As a result, the Logistic equation of population N(t) and time T is</p>
            <DocImg src="https://2021.igem.org/wiki/images/d/d0/T--NJMU-China--Model5.23.png"></DocImg>
            ...
            <DocImg src="https://2021.igem.org/wiki/images/b/bb/T--NJMU-China--Model5.24.png"></DocImg>
            <p>The Equation is: N(t) = 1.7184 / (1 + 33.4369 * exp(-0.0212t))</p>
            <DocImg src="https://2021.igem.org/wiki/images/e/e1/T--NJMU-China--Model5.25.png"></DocImg>
            <p>The Equation is: N(t) = 1.6310 / (1 + 42.4933 * exp(-0.0236t))</p>
            <DocH2 title="Future Plan" id="Future-Plan"></DocH2>
            <!-- <h2>
                Future Plan
                <span id="Future-Plan" class="anchor"></span>
            </h2>-->
            <p>1.We will build a network platform based on our screening model to assist us in providing timely prevention and treatment measures.</p>
            <p>2.Combined with experimental data, we will predict the efficacy of our engineering bacteria.</p>
            <DocH2 title="Reference" id="Reference"></DocH2>
            <pre class="whitespace-pre-line italic p-10 selection:bg-gray-400">
                ...
                8.	Yatawara, C.J., et al., The effect of oxytocin nasal spray on social interaction deficits observed in young children with autism: a randomized clinical crossover trial. Mol Psychiatry, 2016. 21(9): p. 1225-31.
                9.	Ringnér, M., What is principal component analysis? Nat Biotechnol, 2008. 26(3): p. 303-4.
                10.	Wang, J., et al., 3dRNA v2.0: An Updated Web Server for RNA 3D Structure Prediction. Int J Mol Sci, 2019. 20(17).
                11.	Morgenstern, B., DIALIGN: multiple DNA and protein sequence alignment at BiBiServ. Nucleic Acids Res, 2004. 32(Web Server issue): p. W33-6.
                12.	Trott, O. and A.J. Olson, AutoDock Vina: improving the speed and accuracy of docking with a new scoring function, efficient optimization, and multithreading. J Comput Chem, 2010. 31(2): p. 455-61.
                13.	Luo, J., et al., Challenges and current status of computational methods for docking small molecules to nucleic acids. Eur J Med Chem, 2019. 168: p. 414-425.
                14.	Goddard, T.D., et al., UCSF ChimeraX: Meeting modern challenges in visualization and analysis. Protein Sci, 2018. 27(1): p. 14-25.
                ...
                16.	Thevenet, P., et al., PEP-FOLD: an updated de novo structure prediction server for both linear and disulfide bonded cyclic peptides. Nucleic Acids Res, 2012. 40(Web Server issue): p. W288-93.
                17.	Shen, Y., et al., Improved PEP-FOLD Approach for Peptide and Miniprotein Structure Prediction. J Chem Theory Comput, 2014. 10(10): p. 4745-58.
                18.	Esser, D.S., J.H. Leveau, and K.M. Meyer, Modeling microbial growth and dynamics. Appl Microbiol Biotechnol, 2015. 99(21): p. 8831-46.
            </pre>
        </template>
    </DocTemplateVue>
</template>
